        ...
        <div className="mx-auto grid max-w-7xl grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-2 px-3 py-2.5 sm:px-4 sm:py-3 lg:gap-6 lg:px-6 lg:py-3">
          ...
          <div className="flex shrink-0 items-center gap-1.5 sm:gap-2 lg:gap-3">
            ...
            <a
              ...
              className="inline-flex size-10 items-center justify-center gap-2 whitespace-nowrap rounded-xl border border-brand-green bg-brand-white/80 text-brand-green backdrop-blur-sm transition-colors hover:bg-brand-green hover:text-brand-white sm:size-11 2xl:size-auto 2xl:px-4 2xl:py-2.5"
            >
            ...
            <a
              ...
              className="bg-brand-terracotta text-brand-white hover:brightness-105 inline-flex size-10 items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold transition-all sm:size-11 2xl:size-auto 2xl:px-4 2xl:py-2.5"
            >
            ...
            <a
              ...
              className="gradient-accent text-accent-foreground hover:brightness-105 inline-flex size-10 items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold transition-all sm:size-11 xl:size-auto xl:px-4 xl:py-2.5"
            >
              <Calendar className="size-[18px] shrink-0 xl:size-4" strokeWidth={2} />
              <span className="hidden xl:inline">{t("Записаться онлайн", "Записаться онлайн")}</span>
            </a>
